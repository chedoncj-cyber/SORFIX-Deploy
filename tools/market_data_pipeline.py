...
# All listed companies across GSE, JSE, NGX, NSE — sourced from companies_data.py
...
def _generate_book(venue: str, symbol: str, mid: float, depth: int = 10) -> OrderBook:
    ...
    # Venue liquidity multipliers
    liq_mult = {"JSE": 3.0, "NGX": 2.0, "GSE": 1.2, "NSE": 1.0}.get(venue, 1.5)
